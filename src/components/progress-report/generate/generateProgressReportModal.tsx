...
export default function GenerateProgressReportModal({ isOpen, onClose, isLoading, resultMessage }: Props) {
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-70">
      <div className="bg-white rounded-xl p-6 w-full max-w-md text-center shadow-lg">
        <h2 className="text-xl font-bold mb-4 text-black">Generating Progress Reports</h2>
        {isLoading ? (
