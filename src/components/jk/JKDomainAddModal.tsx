...
import { createJKDomain } from '@/services/jkService'
import Spinner from '@/components/Spinner'

interface JKDomainAddModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function JKDomainAddModal({
  isOpen,
  onClose,
  documentType,
  school,
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      const res = await createJKDomain({
        documentType,
        name: name.trim(),
